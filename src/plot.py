...
if __name__ == '__main__':
    ...
    plt.scatter(np.arange(MAX_LEN)[mask], mean_ee[mask], label='mean Excess Entropy')
    plt.scatter(np.arange(MAX_LEN)[mask], mean_tse[mask], label='mean TSE')
